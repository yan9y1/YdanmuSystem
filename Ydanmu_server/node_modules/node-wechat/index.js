...
//检验 token
//prototype.
Wechat.checkSignature = function(req, res) {
  if (req.method === 'GET') {
...
//预处理器
Wechat.handler = function(req, res) {
  //console.log(req);
  var xml = '';
  var self = this;
  self.res = res;
...
//解析器
Wechat.toJSON = function(xml) {
  var msg = {};
  if(xml == ''){
    console.log("收到了一条空消息");
    return;
  }
...
//监听文本信息
Wechat.text = function(callback) {
  emitter.once("text", callback);
  return this;
}

//监听图片信息
Wechat.image = function(callback) {
  emitter.once("image", callback);
  return this;
}

//监听地址信息
Wechat.location = function(callback) {
  emitter.once("location", callback);
  return this;
}

//监听链接信息
Wechat.link = function(callback) {
  emitter.once("link", callback);
  return this;
}

//监听事件信息
Wechat.event = function(callback) {
  emitter.once("event", callback);
  return this;
}

//监听语音信息
Wechat.voice = function(callback) {
  emitter.once("voice", callback);
  return this;
}

//监听视频信息
Wechat.video = function(callback) {
  emitter.once("video", callback);
  return this;
}

//监听所有信息
Wechat.all = function(callback) {
